 ...
 */
export default function CircularStream({ onFileRecorded, buttonClassName = "" }) {
  ...
  const toggleFacing = () => setFacingMode((f) => (f === "user" ? "environment" : "user"));
  ...
  const startRecording = () => {
    ...
    try {
      ...
      mr.onstop = () => {
        ...
        setPreviewUrl(url);
        stopPreview(); // stop camera during preview
        setRecording(false);
  ...
  const handleSend = async () => {
    ...
    setSending(true);
    try {
      const file = new File([recordedBlob], `video-message-${Date.now()}.webm`, { type: "video/webm" });
      // let parent handle sending; allow promise
  ...
  return (
    <>
      ...
      >
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" className="relative z-10">
          <path d="M23 7l-7 5V8.5a2.5 2.5 0 00-2.5-2.5h-9A2 2 0 002 8v8a2 2 0 002 2h9A2.5 2.5 0 0017 15.5V12l7 5V7z" fill="currentColor" />
        </svg>
      </button>
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button 
                    ...
                    aria-label="Close" 
                    title="Close" 
                    className="p-2 rounded-full bg-white/10 hover:bg-white/20 text-white transition-colors duration-200 hover:rotate-90 transition-transform"
                  >
                  ...
                  {!previewUrl ? (
                    <>
                      ...
                      <button 
                        ...
                        className="p-3 rounded-full bg-white/10 hover:bg-white/20 text-white border border-white/20 hover:border-white/30 transition-all duration-200 hover:scale-105" 
                        title="Flip camera" 
                    ...
                    <>
                      ...
                      <button 
                        ...
                        className="px-6 py-3 rounded-full bg-white/10 hover:bg-white/20 text-white font-medium border border-white/20 hover:border-white/30 transition-all duration-200 hover:scale-105"
                      >
